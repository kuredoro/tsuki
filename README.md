...
* **@artembakhanov**: nameserver creation, writing report, debugging, Docker image creation;
* **@kuredoro**: fileserver creation, writing report, testing;
* **@TheSharpOwl**: client creation, writing report.

Protocols are designed by @artembakhanov and @kuredoro.
